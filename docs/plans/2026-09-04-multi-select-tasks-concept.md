...
| In selection mode: **tap** a task                        | Toggles it. Rows show a leading selection ring in this mode (§4.4). Deselecting the last task ends the mode. |
...
| Touch mode when the last task is deselected | Ends the mode, like an Android contextual action bar; a completed bulk action ends it too. Desktop keeps the selection as a working set (Esc clears).                                                                                                                                                                                                                                                                                                            |
