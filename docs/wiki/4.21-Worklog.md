...
So the worklog is a **reorganized view** of the same “time spent per day” data that lives on tasks (and in the archive). When you open History, daily summary, or Quick History mode, the app loads the relevant tasks (active + archive for the context), runs this transformation, and shows the result.
...
- **When the worklog updates** — The worklog is **refreshed** when you navigate to History, daily summary, or Quick History mode, or when you trigger a manual refresh. It does **not** update continuously as you track time; you may need to open the view or refresh to see the latest logged time.

## Review, Editing, and Export

- **Inline time correction** — Leaf-task rows can be corrected inline. The app updates the task's “time spent per day” value for that date, so the corrected time is reflected in History, Quick History, reports, and metrics.
...
- **Refresh** — Updates when you open History, daily summary, or Quick History mode, or when you refresh manually; not live as you track.
...
- [[4.22-Quick-History]] — Week-centric, current-year mode of the same History data
