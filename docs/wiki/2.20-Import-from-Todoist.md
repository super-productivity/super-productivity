...
5. Review the preview: pick the projects to import (projects whose name already exists — for example from a previous run — are flagged and unchecked by default) and optionally enable mapping Todoist priorities to `p1`–`p3` tags.
