...
Node.js execution for plugins is also temporarily disabled in the desktop app while the authorization boundary is hardened. Plugins that declare `nodeExecution` will not be able to run Node.js scripts until this capability is re-enabled.
