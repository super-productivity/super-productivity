...
- Android's home-screen task widget, which can show Today or a selected project;
  opening it shows the selected project's list. Project widgets show open tasks
  and keep tasks completed from the widget visible for five seconds, while
  Today widgets retain completed tasks.
