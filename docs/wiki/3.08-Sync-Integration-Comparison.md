...
- **Android upload timeouts:** An upload may finish on the server after the app times out. The app reports the timeout without immediately replaying the upload; a later sync checks the remote state. This also applies to the WebDAV provider.
