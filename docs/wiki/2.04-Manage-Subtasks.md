...
**Parent task only:** For a top-level (parent) task, you can also right-click it and choose **Move to top** or **Move to bottom** to move it to the top or bottom of the main list respectively. There is no "Move to top" or "Move to bottom" menu entry for subtasks; use the keyboard or drag instead.
