...
[Plainspace](https://plainspace.org) is Super Productivity's optional collaboration layer: it turns a local project into a **shared Space** so you can work on it with others. Tasks assigned to you import automatically, done state stays in sync both ways, and title and schedule changes made in Plainspace pull in on the next poll. This is a network feature — task data in a shared project leaves your device; your other projects and core offline use are unaffected.
