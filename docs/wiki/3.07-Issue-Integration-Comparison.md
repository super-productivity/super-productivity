...
- **Filtering:** Repository-based; scope (All, Created by me, Assigned to me); optional comma-separated label allowlist (server-side AND match) and denylist (client-side), both supporting scoped labels (`scope/name`).
