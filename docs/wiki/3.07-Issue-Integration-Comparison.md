...
| Gitea           | Yes    | No            | No         | No       | No       | No          | Repo, scope, labels  | Up to 400   | —         | —         |
...
- **Auto-import:** Up to 400 issues for the project (4 pages × 100 per page; subject to server-imposed per-page limits).
