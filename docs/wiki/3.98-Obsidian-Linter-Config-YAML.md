...
```yml
{
  'ruleConfigs':
    {
      'add-blank-line-after-yaml': { 'enabled': false },
      ...
      'escape-yaml-special-characters':
        { 'enabled': false, 'try-to-escape-single-line-arrays': false },
      'force-yaml-escape': { 'enabled': false, 'force-yaml-escape-keys': '' },
      'format-tags-in-yaml': { 'enabled': false },
      'format-yaml-array':
        {
          'enabled': false,
          'alias-key': true,
      ...
      'insert-yaml-attributes':
        { 'enabled': false, 'text-to-insert': "aliases: \ntags: " },
      'move-tags-to-yaml':
        {
          'enabled': false,
      ...
      'remove-yaml-keys': { 'enabled': false, 'yaml-keys-to-remove': '' },
      ...
      'header-increment': { 'enabled': true, 'start-at-h2': false },
      'headings-start-line': { 'enabled': true },
      'remove-trailing-punctuation-in-heading':
        { 'enabled': true, 'punctuation-to-remove': '.,;:!。，；：！' },
      ...
      'default-language-for-code-fences': { 'enabled': false, 'default-language': '' },
      'emphasis-style': { 'enabled': true, 'style': 'underscore' },
      'no-bare-urls': { 'enabled': true, 'no-bare-uris': true },
      'ordered-list-style':
        {
          'enabled': true,
      ...
      'strong-style': { 'enabled': true, 'style': 'asterisk' },
      'two-spaces-between-lines-with-content':
        { 'enabled': false, 'line-break-indicator': '  ' },
      'unordered-list-style': { 'enabled': true, 'list-style': '-' },
      'compact-yaml': { 'enabled': false, 'inner-new-lines': false },
      'consecutive-blank-lines': { 'enabled': true },
      'convert-spaces-to-tabs': { 'enabled': false, 'tabsize': 4 },
      ...
      'heading-blank-lines':
        { 'enabled': true, 'bottom': true, 'empty-line-after-yaml': true },
      ...
      'trailing-spaces': { 'enabled': true, 'two-space-line-break': true },
