...
You can navigate to past periods to review completed tasks. Click the checkbox icon in the toolbar to toggle showing done tasks, which appear with a strikethrough style.
