...
While viewing a checklist in the notes editor you can manage it directly: **drag a checklist item** to reorder it, and use the **checklist actions** menu (the list icon next to the editor controls) to **Check all**, **Uncheck all**, or **Clear completed** items in one step. These actions only appear when the notes are recognized as a checklist.
