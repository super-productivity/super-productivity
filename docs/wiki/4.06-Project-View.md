...
If you only want to shelve a project without marking it finished, choose **Archive project** from the same menu instead. Archiving hides the project from active views without setting a completed state or showing the celebration.
