...
On Android, **Restore latest automatic backup** is available in Settings -> Sync & Backup -> Automatic Backups. It restores the newest usable automatic backup slot after confirmation and replaces the current local data.
