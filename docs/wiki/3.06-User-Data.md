...
Android home-screen widget project selections are device-local. They are not
included in app backups and are excluded from Android system backup and device
transfer because restored launcher widgets receive different widget IDs.
