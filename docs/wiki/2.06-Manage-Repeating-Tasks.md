...
Below **Start date**, the dialog shows when the next instance will be created, and, if **Inherit subtasks** is on, the subtasks it will get. After a schedule change, the date updates once you save.
