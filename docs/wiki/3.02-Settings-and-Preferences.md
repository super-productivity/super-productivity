...
- **Automatically pass parent dates to newly created subtasks** — When enabled, newly created subtasks will inherit the parent task's due dates or deadlines.
  - **Automatically pass parent due date to newly created subtasks** — Toggles due date inheritance.
  - **Automatically pass parent deadline to newly created subtasks** — Toggles deadline inheritance.
