...
- **Show recurring task activity when editing a recurring task config** — Opens
  the "Edit recurring task" dialog with the Activity section (the series'
  tracked-time heatmap) already expanded instead of collapsed.
