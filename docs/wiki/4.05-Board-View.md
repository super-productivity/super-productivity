...
- **Filters** that determine which tasks appear in that panel (by tags, completion status, scheduling/timeframe, deadlines, one or multiple projects, backlog status, etc.)
