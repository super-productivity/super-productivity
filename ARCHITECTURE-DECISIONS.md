...
| **Time sessions are optional task annotations** — daily totals remain authoritative; recordings extend existing timer delta operations without a schema bump | [time-session-annotations.md](docs/sync-and-op-log/time-session-annotations.md)                                                                                                                                                                                  |
