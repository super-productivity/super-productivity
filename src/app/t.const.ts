const T = {
  ...
  F: {
    ...
    LOGSEQ: {
      FORM: {
        API_URL: 'F.LOGSEQ.FORM.API_URL',
        AUTH_TOKEN: 'F.LOGSEQ.FORM.AUTH_TOKEN',
        ADVANCED_CONFIG: 'F.LOGSEQ.FORM.ADVANCED_CONFIG',
        QUERY_FILTER: 'F.LOGSEQ.FORM.QUERY_FILTER',
        QUERY_FILTER_PLACEHOLDER: 'F.LOGSEQ.FORM.QUERY_FILTER_PLACEHOLDER',
        QUERY_FILTER_DESCRIPTION: 'F.LOGSEQ.FORM.QUERY_FILTER_DESCRIPTION',
        INCLUDE_MARKER_IN_UPDATE: 'F.LOGSEQ.FORM.INCLUDE_MARKER_IN_UPDATE',
        INCLUDE_MARKER_IN_UPDATE_DESCRIPTION:
          'F.LOGSEQ.FORM.INCLUDE_MARKER_IN_UPDATE_DESCRIPTION',
        TASK_WORKFLOW: 'F.LOGSEQ.FORM.TASK_WORKFLOW',
        TASK_WORKFLOW_DESCRIPTION: 'F.LOGSEQ.FORM.TASK_WORKFLOW_DESCRIPTION',
        WORKFLOW_TODO_DOING: 'F.LOGSEQ.FORM.WORKFLOW_TODO_DOING',
        WORKFLOW_NOW_LATER: 'F.LOGSEQ.FORM.WORKFLOW_NOW_LATER',
        LINK_FORMAT: 'F.LOGSEQ.FORM.LINK_FORMAT',
        LINK_FORMAT_LOGSEQ_URL: 'F.LOGSEQ.FORM.LINK_FORMAT_LOGSEQ_URL',
        LINK_FORMAT_HTTP_URL: 'F.LOGSEQ.FORM.LINK_FORMAT_HTTP_URL',
      },
      FORM_SECTION: {
        HELP: 'F.LOGSEQ.FORM_SECTION.HELP',
      },
      DISCREPANCY: {
        DONE_IN_LOGSEQ: 'F.LOGSEQ.DISCREPANCY.DONE_IN_LOGSEQ',
        DONE_IN_SUPERPROD: 'F.LOGSEQ.DISCREPANCY.DONE_IN_SUPERPROD',
        ACTIVE_IN_LOGSEQ: 'F.LOGSEQ.DISCREPANCY.ACTIVE_IN_LOGSEQ',
        ACTIVE_IN_SUPERPROD: 'F.LOGSEQ.DISCREPANCY.ACTIVE_IN_SUPERPROD',
        SET_LOGSEQ_TODO: 'F.LOGSEQ.DISCREPANCY.SET_LOGSEQ_TODO',
        SET_LOGSEQ_DONE: 'F.LOGSEQ.DISCREPANCY.SET_LOGSEQ_DONE',
        SET_LOGSEQ_DOING: 'F.LOGSEQ.DISCREPANCY.SET_LOGSEQ_DOING',
        COMPLETE: 'F.LOGSEQ.DISCREPANCY.COMPLETE',
        SET_SUPERPROD_NOT_DONE: 'F.LOGSEQ.DISCREPANCY.SET_SUPERPROD_NOT_DONE',
        ACTIVATE: 'F.LOGSEQ.DISCREPANCY.ACTIVATE',
        DEACTIVATE: 'F.LOGSEQ.DISCREPANCY.DEACTIVATE',
        DEACTIVATE_TASK: 'F.LOGSEQ.DISCREPANCY.DEACTIVATE_TASK',
        MULTIPLE_ACTIVE_IN_LOGSEQ: 'F.LOGSEQ.DISCREPANCY.MULTIPLE_ACTIVE_IN_LOGSEQ',
        SINGLE_ACTIVE_IN_LOGSEQ: 'F.LOGSEQ.DISCREPANCY.SINGLE_ACTIVE_IN_LOGSEQ',
        WHICH_TO_ACTIVATE: 'F.LOGSEQ.DISCREPANCY.WHICH_TO_ACTIVATE',
        ACTIVATE_NONE: 'F.LOGSEQ.DISCREPANCY.ACTIVATE_NONE',
        ACTIVE_TASKS: 'F.LOGSEQ.DISCREPANCY.ACTIVE_TASKS',
        STATUS_LOGSEQ_DOING_SP_INACTIVE:
          'F.LOGSEQ.DISCREPANCY.STATUS_LOGSEQ_DOING_SP_INACTIVE',
        STATUS_SP_ACTIVE_LOGSEQ_TODO: 'F.LOGSEQ.DISCREPANCY.STATUS_SP_ACTIVE_LOGSEQ_TODO',
        STATUS_LOGSEQ_DONE_SP_OPEN: 'F.LOGSEQ.DISCREPANCY.STATUS_LOGSEQ_DONE_SP_OPEN',
        STATUS_SP_DONE_LOGSEQ_OPEN: 'F.LOGSEQ.DISCREPANCY.STATUS_SP_DONE_LOGSEQ_OPEN',
      },
    },
    MARKDOWN_PASTE: {
