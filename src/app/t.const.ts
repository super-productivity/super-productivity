const T = {
  ...
  F: {
    ...
    FORGEJO: {
      FORM: {
        EXCLUDE_LABELS: 'F.FORGEJO.FORM.EXCLUDE_LABELS',
        EXCLUDE_LABELS_DESCRIPTION: 'F.FORGEJO.FORM.EXCLUDE_LABELS_DESCRIPTION',
        FILTER_LABELS: 'F.FORGEJO.FORM.FILTER_LABELS',
        FILTER_LABELS_DESCRIPTION: 'F.FORGEJO.FORM.FILTER_LABELS_DESCRIPTION',
        HOST: 'F.FORGEJO.FORM.HOST',
        REPO_FULL_NAME: 'F.FORGEJO.FORM.REPO_FULL_NAME',
        REPO_FULL_NAME_DESCRIPTION: 'F.FORGEJO.FORM.REPO_FULL_NAME_DESCRIPTION',
        SCOPE: 'F.FORGEJO.FORM.SCOPE',
        SCOPE_ALL: 'F.FORGEJO.FORM.SCOPE_ALL',
        SCOPE_ASSIGNED: 'F.FORGEJO.FORM.SCOPE_ASSIGNED',
        SCOPE_CREATED: 'F.FORGEJO.FORM.SCOPE_CREATED',
        TOKEN: 'F.FORGEJO.FORM.TOKEN',
      },
      FORM_SECTION: {
        HELP: 'F.FORGEJO.FORM_SECTION.HELP',
      },
      ISSUE_CONTENT: {
        ASSIGNEE: 'F.FORGEJO.ISSUE_CONTENT.ASSIGNEE',
        DESCRIPTION: 'F.FORGEJO.ISSUE_CONTENT.DESCRIPTION',
        LABELS: 'F.FORGEJO.ISSUE_CONTENT.LABELS',
        MARK_AS_CHECKED: 'F.FORGEJO.ISSUE_CONTENT.MARK_AS_CHECKED',
        PROJECT: 'F.FORGEJO.ISSUE_CONTENT.PROJECT',
        STATUS: 'F.FORGEJO.ISSUE_CONTENT.STATUS',
        SUMMARY: 'F.FORGEJO.ISSUE_CONTENT.SUMMARY',
        WRITE_A_COMMENT: 'F.FORGEJO.ISSUE_CONTENT.WRITE_A_COMMENT',
      },
    },
    CODEBERG: {
      FORM: {
        EXCLUDE_LABELS: 'F.CODEBERG.FORM.EXCLUDE_LABELS',
        EXCLUDE_LABELS_DESCRIPTION: 'F.CODEBERG.FORM.EXCLUDE_LABELS_DESCRIPTION',
        FILTER_LABELS: 'F.CODEBERG.FORM.FILTER_LABELS',
        FILTER_LABELS_DESCRIPTION: 'F.CODEBERG.FORM.FILTER_LABELS_DESCRIPTION',
        HOST: 'F.CODEBERG.FORM.HOST',
        REPO_FULL_NAME: 'F.CODEBERG.FORM.REPO_FULL_NAME',
        REPO_FULL_NAME_DESCRIPTION: 'F.CODEBERG.FORM.REPO_FULL_NAME_DESCRIPTION',
        SCOPE: 'F.CODEBERG.FORM.SCOPE',
        SCOPE_ALL: 'F.CODEBERG.FORM.SCOPE_ALL',
        SCOPE_ASSIGNED: 'F.CODEBERG.FORM.SCOPE_ASSIGNED',
        SCOPE_CREATED: 'F.CODEBERG.FORM.SCOPE_CREATED',
        TOKEN: 'F.CODEBERG.FORM.TOKEN',
      },
      FORM_SECTION: {
        HELP: 'F.CODEBERG.FORM_SECTION.HELP',
      },
      ISSUE_CONTENT: {
        ASSIGNEE: 'F.CODEBERG.ISSUE_CONTENT.ASSIGNEE',
        DESCRIPTION: 'F.CODEBERG.ISSUE_CONTENT.DESCRIPTION',
        LABELS: 'F.CODEBERG.ISSUE_CONTENT.LABELS',
        MARK_AS_CHECKED: 'F.CODEBERG.ISSUE_CONTENT.MARK_AS_CHECKED',
        PROJECT: 'F.CODEBERG.ISSUE_CONTENT.PROJECT',
        STATUS: 'F.CODEBERG.ISSUE_CONTENT.STATUS',
        SUMMARY: 'F.CODEBERG.ISSUE_CONTENT.SUMMARY',
        WRITE_A_COMMENT: 'F.CODEBERG.ISSUE_CONTENT.WRITE_A_COMMENT',
      },
    },
    GITLAB: {
