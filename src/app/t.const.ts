const T = {
  ...
  F: {
    ...
    TASK: {
      ...
      TASK_SELECTION: {
        COUNT: 'F.TASK.TASK_SELECTION.COUNT',
        SELECT_TASK: 'F.TASK.TASK_SELECTION.SELECT_TASK',
        TITLE: 'F.TASK.TASK_SELECTION.TITLE',
        D_CONFIRM_DELETE: {
          MSG: 'F.TASK.TASK_SELECTION.D_CONFIRM_DELETE.MSG',
        },
      },
      SUMMARY_TABLE: {
