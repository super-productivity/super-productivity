const T = {
  ...
  F: {
    ...
    TEAM: {
      TITLE: 'F.TEAM.TITLE',
      S: {
        CONNECTED: 'F.TEAM.S.CONNECTED',
        DISCONNECTED: 'F.TEAM.S.DISCONNECTED',
        SYNC_SUCCESS: 'F.TEAM.S.SYNC_SUCCESS',
        SYNC_FAILED: 'F.TEAM.S.SYNC_FAILED',
      },
      SETTINGS: {
        TITLE: 'F.TEAM.SETTINGS.TITLE',
        SERVER_URL: 'F.TEAM.SETTINGS.SERVER_URL',
        API_TOKEN: 'F.TEAM.SETTINGS.API_TOKEN',
        SYNC_INTERVAL: 'F.TEAM.SETTINGS.SYNC_INTERVAL',
        IS_AUTO_SYNC: 'F.TEAM.SETTINGS.IS_AUTO_SYNC',
        IS_ENABLED: 'F.TEAM.SETTINGS.IS_ENABLED',
        CONNECT: 'F.TEAM.SETTINGS.CONNECT',
        DISCONNECT: 'F.TEAM.SETTINGS.DISCONNECT',
        SYNC_NOW: 'F.TEAM.SETTINGS.SYNC_NOW',
      },
      ISSUES: {
        TITLE: 'F.TEAM.ISSUES.TITLE',
        NO_ISSUES: 'F.TEAM.ISSUES.NO_ISSUES',
        STATUS_BACKLOG: 'F.TEAM.ISSUES.STATUS_BACKLOG',
        STATUS_TODO: 'F.TEAM.ISSUES.STATUS_TODO',
        STATUS_IN_PROGRESS: 'F.TEAM.ISSUES.STATUS_IN_PROGRESS',
        STATUS_IN_REVIEW: 'F.TEAM.ISSUES.STATUS_IN_REVIEW',
        STATUS_DONE: 'F.TEAM.ISSUES.STATUS_DONE',
        STATUS_CANCELLED: 'F.TEAM.ISSUES.STATUS_CANCELLED',
        PRIORITY_URGENT: 'F.TEAM.ISSUES.PRIORITY_URGENT',
        PRIORITY_HIGH: 'F.TEAM.ISSUES.PRIORITY_HIGH',
        PRIORITY_MEDIUM: 'F.TEAM.ISSUES.PRIORITY_MEDIUM',
        PRIORITY_LOW: 'F.TEAM.ISSUES.PRIORITY_LOW',
        PRIORITY_NONE: 'F.TEAM.ISSUES.PRIORITY_NONE',
      },
    },
    TASK: {
      ADDITIONAL_INFO: {
