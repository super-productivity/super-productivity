...
describe('TaskRepeatCfgFormConfig', () => {
  ...
  // NOTE: the quickSetting `change` handler was removed with the formly select.
  // Its reference-date behaviour (#5806) now lives in the dialog component's
  // onQuickSettingSelect — covered in dialog-edit-task-repeat-cfg.component.spec.
});
