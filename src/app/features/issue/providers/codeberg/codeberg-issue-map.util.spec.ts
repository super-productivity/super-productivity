...
import { CodebergIssue, CodebergLabel } from './codeberg-issue.model';

const makeLabel = (name: string): CodebergLabel =>
  ({ id: 0, name, color: '', description: '', url: '' }) as CodebergLabel;

const makeIssue = (labels: CodebergLabel[] | undefined): CodebergIssue =>
  ({ labels }) as unknown as CodebergIssue;

describe('codeberg-issue-map.util', () => {
