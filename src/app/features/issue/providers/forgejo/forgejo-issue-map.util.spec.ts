...
import { ForgejoIssue, ForgejoLabel } from './forgejo-issue.model';

const makeLabel = (name: string): ForgejoLabel =>
  ({ id: 0, name, color: '', description: '', url: '' }) as ForgejoLabel;

const makeIssue = (labels: ForgejoLabel[] | undefined): ForgejoIssue =>
  ({ labels }) as unknown as ForgejoIssue;

describe('forgejo-issue-map.util', () => {
